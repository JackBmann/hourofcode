object Fibonacci {
  def main(args: Array[String]): Unit = {
  	// Prompt user to enter the desired amount of
  	// elements of the Fibonacci sequence to print.
  	println("Enter the amount of Fibonacci Numbers you want to print")

  	// Take a user input for the amount of Fibonacci numbers to print.
  	val sizeOfFibonacciNumbers = scala.io.StdIn.readLine()

  	// Store the Fibonacci numbers in an array.
    val fibonacciNumbers = getFibonacciNumbers(sizeOfFibonacciNumbers)

    // Print the elements of the Fibonacci numbers array.
